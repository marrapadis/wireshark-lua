...
local siac_cts_output_cta_v2_9 = Proto("Siac.Cts.Output.Cta.v2.9.Lua", "Siac Cts Output Cta 2.9")
...
siac_cts_output_cta_v2_9.fields.administrative = ProtoField.new("Administrative", "siac.cts.output.cta.v2.9.administrative", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.administrative_message_type = ProtoField.new("Administrative Message Type", "siac.cts.output.cta.v2.9.administrativemessagetype", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.administrative_payload = ProtoField.new("Administrative Payload", "siac.cts.output.cta.v2.9.administrativepayload", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.approximate_adjusted_volume_market_center_message = ProtoField.new("Approximate Adjusted Volume Market Center Message", "siac.cts.output.cta.v2.9.approximateadjustedvolumemarketcentermessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.approximate_trades_and_total_dollar_value_message = ProtoField.new("Approximate Trades And Total Dollar Value Message", "siac.cts.output.cta.v2.9.approximatetradesandtotaldollarvaluemessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.auction_collar_lower_threshold_price = ProtoField.new("Auction Collar Lower Threshold Price", "siac.cts.output.cta.v2.9.auctioncollarlowerthresholdprice", ftypes.DOUBLE)
siac_cts_output_cta_v2_9.fields.auction_collar_reference_price = ProtoField.new("Auction Collar Reference Price", "siac.cts.output.cta.v2.9.auctioncollarreferenceprice", ftypes.DOUBLE)
siac_cts_output_cta_v2_9.fields.auction_collar_upper_threshold_price = ProtoField.new("Auction Collar Upper Threshold Price", "siac.cts.output.cta.v2.9.auctioncollarupperthresholdprice", ftypes.DOUBLE)
siac_cts_output_cta_v2_9.fields.auction_status_message = ProtoField.new("Auction Status Message", "siac.cts.output.cta.v2.9.auctionstatusmessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.bid_and_offer_index_message = ProtoField.new("Bid And Offer Index Message", "siac.cts.output.cta.v2.9.bidandofferindexmessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.bid_index_value = ProtoField.new("Bid Index Value", "siac.cts.output.cta.v2.9.bidindexvalue", ftypes.INT64)
siac_cts_output_cta_v2_9.fields.block_checksum = ProtoField.new("Block Checksum", "siac.cts.output.cta.v2.9.blockchecksum", ftypes.UINT16)
siac_cts_output_cta_v2_9.fields.block_header = ProtoField.new("Block Header", "siac.cts.output.cta.v2.9.blockheader", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.block_pad_byte = ProtoField.new("Block Pad Byte", "siac.cts.output.cta.v2.9.blockpadbyte", ftypes.UINT8)
siac_cts_output_cta_v2_9.fields.block_sequence_number = ProtoField.new("Block Sequence Number", "siac.cts.output.cta.v2.9.blocksequencenumber", ftypes.UINT32)
siac_cts_output_cta_v2_9.fields.block_size = ProtoField.new("Block Size", "siac.cts.output.cta.v2.9.blocksize", ftypes.UINT16)
siac_cts_output_cta_v2_9.fields.buy_volume = ProtoField.new("Buy Volume", "siac.cts.output.cta.v2.9.buyvolume", ftypes.UINT32)
siac_cts_output_cta_v2_9.fields.cancel_error_action = ProtoField.new("Cancel Error Action", "siac.cts.output.cta.v2.9.cancelerroraction", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.consolidated_data = ProtoField.new("Consolidated Data", "siac.cts.output.cta.v2.9.consolidateddata", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.consolidated_end_of_day_summary_message = ProtoField.new("Consolidated End Of Day Summary Message", "siac.cts.output.cta.v2.9.consolidatedendofdaysummarymessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.consolidated_high_low_last_indicator = ProtoField.new("Consolidated High Low Last Indicator", "siac.cts.output.cta.v2.9.consolidatedhighlowlastindicator", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.consolidated_start_of_day_summary_message = ProtoField.new("Consolidated Start Of Day Summary Message", "siac.cts.output.cta.v2.9.consolidatedstartofdaysummarymessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.control = ProtoField.new("Control", "siac.cts.output.cta.v2.9.control", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.control_message_type = ProtoField.new("Control Message Type", "siac.cts.output.cta.v2.9.controlmessagetype", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.control_payload = ProtoField.new("Control Payload", "siac.cts.output.cta.v2.9.controlpayload", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.corrected_trade = ProtoField.new("Corrected Trade", "siac.cts.output.cta.v2.9.correctedtrade", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.crossing_session_1_total_trades_volume = ProtoField.new("Crossing Session 1 Total Trades Volume", "siac.cts.output.cta.v2.9.crossingsession1totaltradesvolume", ftypes.UINT64)
siac_cts_output_cta_v2_9.fields.crossing_session_2_dollar_value = ProtoField.new("Crossing Session 2 Dollar Value", "siac.cts.output.cta.v2.9.crossingsession2dollarvalue", ftypes.UINT64)
siac_cts_output_cta_v2_9.fields.crossing_session_2_total_trades_volume = ProtoField.new("Crossing Session 2 Total Trades Volume", "siac.cts.output.cta.v2.9.crossingsession2totaltradesvolume", ftypes.UINT64)
siac_cts_output_cta_v2_9.fields.crossing_session_summary_message = ProtoField.new("Crossing Session Summary Message", "siac.cts.output.cta.v2.9.crossingsessionsummarymessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.data_feed_indicator = ProtoField.new("Data Feed Indicator", "siac.cts.output.cta.v2.9.datafeedindicator", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.disaster_recovery_data_center_activation_message = ProtoField.new("Disaster Recovery Data Center Activation Message", "siac.cts.output.cta.v2.9.disasterrecoverydatacenteractivationmessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.dollar_value = ProtoField.new("Dollar Value", "siac.cts.output.cta.v2.9.dollarvalue", ftypes.UINT64)
...
siac_cts_output_cta_v2_9.fields.held_trade_indicator = ProtoField.new("Held Trade Indicator", "siac.cts.output.cta.v2.9.heldtradeindicator", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.high_indication_price_upper_limit_price_band = ProtoField.new("High Indication Price Upper Limit Price Band", "siac.cts.output.cta.v2.9.highindicationpriceupperlimitpriceband", ftypes.DOUBLE)
siac_cts_output_cta_v2_9.fields.high_price = ProtoField.new("High Price", "siac.cts.output.cta.v2.9.highprice", ftypes.DOUBLE)
siac_cts_output_cta_v2_9.fields.index = ProtoField.new("Index", "siac.cts.output.cta.v2.9.index", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.index_message = ProtoField.new("Index Message", "siac.cts.output.cta.v2.9.indexmessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.index_message_type = ProtoField.new("Index Message Type", "siac.cts.output.cta.v2.9.indexmessagetype", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.index_payload = ProtoField.new("Index Payload", "siac.cts.output.cta.v2.9.indexpayload", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.index_symbol = ProtoField.new("Index Symbol", "siac.cts.output.cta.v2.9.indexsymbol", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.index_value = ProtoField.new("Index Value", "siac.cts.output.cta.v2.9.indexvalue", ftypes.INT64)
siac_cts_output_cta_v2_9.fields.initiating_participant_id = ProtoField.new("Initiating Participant Id", "siac.cts.output.cta.v2.9.initiatingparticipantid", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.instrument_type = ProtoField.new("Instrument Type", "siac.cts.output.cta.v2.9.instrumenttype", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.last_participant_id = ProtoField.new("Last Participant Id", "siac.cts.output.cta.v2.9.lastparticipantid", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.last_price = ProtoField.new("Last Price", "siac.cts.output.cta.v2.9.lastprice", ftypes.DOUBLE)
siac_cts_output_cta_v2_9.fields.limit_up_limit_down_indicator = ProtoField.new("Limit Up Limit Down Indicator", "siac.cts.output.cta.v2.9.limituplimitdownindicator", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.line_integrity_message = ProtoField.new("Line Integrity Message", "siac.cts.output.cta.v2.9.lineintegritymessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.long_trade_message = ProtoField.new("Long Trade Message", "siac.cts.output.cta.v2.9.longtrademessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.low_indication_price_lower_limit_price_band = ProtoField.new("Low Indication Price Lower Limit Price Band", "siac.cts.output.cta.v2.9.lowindicationpricelowerlimitpriceband", ftypes.DOUBLE)
siac_cts_output_cta_v2_9.fields.low_price = ProtoField.new("Low Price", "siac.cts.output.cta.v2.9.lowprice", ftypes.DOUBLE)
siac_cts_output_cta_v2_9.fields.market_status = ProtoField.new("Market Status", "siac.cts.output.cta.v2.9.marketstatus", ftypes.STRING)
...
siac_cts_output_cta_v2_9.fields.message_header = ProtoField.new("Message Header", "siac.cts.output.cta.v2.9.messageheader", ftypes.STRING)
...
siac_cts_output_cta_v2_9.fields.number_of_extensions = ProtoField.new("Number Of Extensions", "siac.cts.output.cta.v2.9.numberofextensions", ftypes.UINT8)
siac_cts_output_cta_v2_9.fields.number_of_participants = ProtoField.new("Number Of Participants", "siac.cts.output.cta.v2.9.numberofparticipants", ftypes.UINT8)
siac_cts_output_cta_v2_9.fields.offer_index_value = ProtoField.new("Offer Index Value", "siac.cts.output.cta.v2.9.offerindexvalue", ftypes.INT64)
siac_cts_output_cta_v2_9.fields.open_price = ProtoField.new("Open Price", "siac.cts.output.cta.v2.9.openprice", ftypes.DOUBLE)
siac_cts_output_cta_v2_9.fields.original_participant_reference_number = ProtoField.new("Original Participant Reference Number", "siac.cts.output.cta.v2.9.originalparticipantreferencenumber", ftypes.INT64)
siac_cts_output_cta_v2_9.fields.original_trade = ProtoField.new("Original Trade", "siac.cts.output.cta.v2.9.originaltrade", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.packet = ProtoField.new("Packet", "siac.cts.output.cta.v2.9.packet", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.participant_data = ProtoField.new("Participant Data", "siac.cts.output.cta.v2.9.participantdata", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.participant_end_of_day_summary_message = ProtoField.new("Participant End Of Day Summary Message", "siac.cts.output.cta.v2.9.participantendofdaysummarymessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.participant_id = ProtoField.new("Participant Id", "siac.cts.output.cta.v2.9.participantid", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.participant_open_high_low_last_indicator = ProtoField.new("Participant Open High Low Last Indicator", "siac.cts.output.cta.v2.9.participantopenhighlowlastindicator", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.participant_reference_number = ProtoField.new("Participant Reference Number", "siac.cts.output.cta.v2.9.participantreferencenumber", ftypes.INT64)
siac_cts_output_cta_v2_9.fields.participant_start_of_day_summary_message = ProtoField.new("Participant Start Of Day Summary Message", "siac.cts.output.cta.v2.9.participantstartofdaysummarymessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.participants = ProtoField.new("Participants", "siac.cts.output.cta.v2.9.participants", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.payload = ProtoField.new("Payload", "siac.cts.output.cta.v2.9.payload", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.previous_close_price = ProtoField.new("Previous Close Price", "siac.cts.output.cta.v2.9.previouscloseprice", ftypes.DOUBLE)
siac_cts_output_cta_v2_9.fields.previous_close_price_date = ProtoField.new("Previous Close Price Date", "siac.cts.output.cta.v2.9.previousclosepricedate", ftypes.UINT32)
siac_cts_output_cta_v2_9.fields.primary_listing_market_participant_id = ProtoField.new("Primary Listing Market Participant Id", "siac.cts.output.cta.v2.9.primarylistingmarketparticipantid", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.prior_day = ProtoField.new("Prior Day", "siac.cts.output.cta.v2.9.priorday", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.prior_day_message_type = ProtoField.new("Prior Day Message Type", "siac.cts.output.cta.v2.9.priordaymessagetype", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.prior_day_payload = ProtoField.new("Prior Day Payload", "siac.cts.output.cta.v2.9.priordaypayload", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.prior_day_trade_correction_message = ProtoField.new("Prior Day Trade Correction Message", "siac.cts.output.cta.v2.9.priordaytradecorrectionmessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.prior_day_trade_date_and_time = ProtoField.new("Prior Day Trade Date And Time", "siac.cts.output.cta.v2.9.priordaytradedateandtime", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.prior_day_trade_message = ProtoField.new("Prior Day Trade Message", "siac.cts.output.cta.v2.9.priordaytrademessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.reserved = ProtoField.new("Reserved", "siac.cts.output.cta.v2.9.reserved", ftypes.UINT8)
siac_cts_output_cta_v2_9.fields.reset_block_sequence_number_message = ProtoField.new("Reset Block Sequence Number Message", "siac.cts.output.cta.v2.9.resetblocksequencenumbermessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.retransmission_indicator = ProtoField.new("Retransmission Indicator", "siac.cts.output.cta.v2.9.retransmissionindicator", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.sale_condition = ProtoField.new("Sale Condition", "siac.cts.output.cta.v2.9.salecondition", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.sale_condition_category = ProtoField.new("Sale Condition Category", "siac.cts.output.cta.v2.9.saleconditioncategory", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.sale_conditions = ProtoField.new("Sale Conditions", "siac.cts.output.cta.v2.9.saleconditions", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.seconds = ProtoField.new("Seconds", "siac.cts.output.cta.v2.9.seconds", ftypes.UINT32)
siac_cts_output_cta_v2_9.fields.security_status = ProtoField.new("Security Status", "siac.cts.output.cta.v2.9.securitystatus", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.security_symbol = ProtoField.new("Security Symbol", "siac.cts.output.cta.v2.9.securitysymbol", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.security_symbol_short = ProtoField.new("Security Symbol Short", "siac.cts.output.cta.v2.9.securitysymbolshort", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.sell_volume = ProtoField.new("Sell Volume", "siac.cts.output.cta.v2.9.sellvolume", ftypes.UINT32)
siac_cts_output_cta_v2_9.fields.sellers_sale_days = ProtoField.new("Sellers Sale Days", "siac.cts.output.cta.v2.9.sellerssaledays", ftypes.UINT8)
siac_cts_output_cta_v2_9.fields.settlement_type = ProtoField.new("Settlement Type", "siac.cts.output.cta.v2.9.settlementtype", ftypes.STRING)
...
siac_cts_output_cta_v2_9.fields.stop_stock_indicator = ProtoField.new("Stop Stock Indicator", "siac.cts.output.cta.v2.9.stopstockindicator", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.summary = ProtoField.new("Summary", "siac.cts.output.cta.v2.9.summary", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.summary_message_type = ProtoField.new("Summary Message Type", "siac.cts.output.cta.v2.9.summarymessagetype", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.summary_payload = ProtoField.new("Summary Payload", "siac.cts.output.cta.v2.9.summarypayload", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.tick = ProtoField.new("Tick", "siac.cts.output.cta.v2.9.tick", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.timestamp_1 = ProtoField.new("Timestamp 1", "siac.cts.output.cta.v2.9.timestamp1", ftypes.STRING)
...
siac_cts_output_cta_v2_9.fields.trade_message_type = ProtoField.new("Trade Message Type", "siac.cts.output.cta.v2.9.trademessagetype", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.trade_payload = ProtoField.new("Trade Payload", "siac.cts.output.cta.v2.9.tradepayload", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.trade_price = ProtoField.new("Trade Price", "siac.cts.output.cta.v2.9.tradeprice", ftypes.DOUBLE)
siac_cts_output_cta_v2_9.fields.trade_price_short = ProtoField.new("Trade Price Short", "siac.cts.output.cta.v2.9.tradepriceshort", ftypes.DOUBLE)
...
siac_cts_output_cta_v2_9.fields.trading_status_message = ProtoField.new("Trading Status Message", "siac.cts.output.cta.v2.9.tradingstatusmessage", ftypes.STRING)
siac_cts_output_cta_v2_9.fields.transaction_id = ProtoField.new("Transaction Id", "siac.cts.output.cta.v2.9.transactionid", ftypes.UINT32)
siac_cts_output_cta_v2_9.fields.version = ProtoField.new("Version", "siac.cts.output.cta.v2.9.version", ftypes.UINT8)
...
siac_cts_output_cta_v2_9.prefs.show_administrative = Pref.bool("Show Administrative", show.administrative, "Parse and add Administrative to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_approximate_adjusted_volume_market_center_message = Pref.bool("Show Approximate Adjusted Volume Market Center Message", show.approximate_adjusted_volume_market_center_message, "Parse and add Approximate Adjusted Volume Market Center Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_approximate_trades_and_total_dollar_value_message = Pref.bool("Show Approximate Trades And Total Dollar Value Message", show.approximate_trades_and_total_dollar_value_message, "Parse and add Approximate Trades And Total Dollar Value Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_auction_status_message = Pref.bool("Show Auction Status Message", show.auction_status_message, "Parse and add Auction Status Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_bid_and_offer_index_message = Pref.bool("Show Bid And Offer Index Message", show.bid_and_offer_index_message, "Parse and add Bid And Offer Index Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_block_header = Pref.bool("Show Block Header", show.block_header, "Parse and add Block Header to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_consolidated_data = Pref.bool("Show Consolidated Data", show.consolidated_data, "Parse and add Consolidated Data to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_consolidated_end_of_day_summary_message = Pref.bool("Show Consolidated End Of Day Summary Message", show.consolidated_end_of_day_summary_message, "Parse and add Consolidated End Of Day Summary Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_consolidated_start_of_day_summary_message = Pref.bool("Show Consolidated Start Of Day Summary Message", show.consolidated_start_of_day_summary_message, "Parse and add Consolidated Start Of Day Summary Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_control = Pref.bool("Show Control", show.control, "Parse and add Control to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_corrected_trade = Pref.bool("Show Corrected Trade", show.corrected_trade, "Parse and add Corrected Trade to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_crossing_session_summary_message = Pref.bool("Show Crossing Session Summary Message", show.crossing_session_summary_message, "Parse and add Crossing Session Summary Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_disaster_recovery_data_center_activation_message = Pref.bool("Show Disaster Recovery Data Center Activation Message", show.disaster_recovery_data_center_activation_message, "Parse and add Disaster Recovery Data Center Activation Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_end_of_day_message = Pref.bool("Show End Of Day Message", show.end_of_day_message, "Parse and add End Of Day Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_end_of_end_of_day_message = Pref.bool("Show End Of End Of Day Message", show.end_of_end_of_day_message, "Parse and add End Of End Of Day Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_end_of_start_of_day_message = Pref.bool("Show End Of Start Of Day Message", show.end_of_start_of_day_message, "Parse and add End Of Start Of Day Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_index = Pref.bool("Show Index", show.index, "Parse and add Index to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_index_message = Pref.bool("Show Index Message", show.index_message, "Parse and add Index Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_line_integrity_message = Pref.bool("Show Line Integrity Message", show.line_integrity_message, "Parse and add Line Integrity Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_long_trade_message = Pref.bool("Show Long Trade Message", show.long_trade_message, "Parse and add Long Trade Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_market_status = Pref.bool("Show Market Status", show.market_status, "Parse and add Market Status to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_market_wide_circuit_breaker_decline_level_status_message = Pref.bool("Show Market Wide Circuit Breaker Decline Level Status Message", show.market_wide_circuit_breaker_decline_level_status_message, "Parse and add Market Wide Circuit Breaker Decline Level Status Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_market_wide_circuit_breaker_status_message = Pref.bool("Show Market Wide Circuit Breaker Status Message", show.market_wide_circuit_breaker_status_message, "Parse and add Market Wide Circuit Breaker Status Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_original_trade = Pref.bool("Show Original Trade", show.original_trade, "Parse and add Original Trade to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_participant_data = Pref.bool("Show Participant Data", show.participant_data, "Parse and add Participant Data to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_participant_end_of_day_summary_message = Pref.bool("Show Participant End Of Day Summary Message", show.participant_end_of_day_summary_message, "Parse and add Participant End Of Day Summary Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_participant_start_of_day_summary_message = Pref.bool("Show Participant Start Of Day Summary Message", show.participant_start_of_day_summary_message, "Parse and add Participant Start Of Day Summary Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_participants = Pref.bool("Show Participants", show.participants, "Parse and add Participants to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_prior_day = Pref.bool("Show Prior Day", show.prior_day, "Parse and add Prior Day to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_prior_day_trade_correction_message = Pref.bool("Show Prior Day Trade Correction Message", show.prior_day_trade_correction_message, "Parse and add Prior Day Trade Correction Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_prior_day_trade_date_and_time = Pref.bool("Show Prior Day Trade Date And Time", show.prior_day_trade_date_and_time, "Parse and add Prior Day Trade Date And Time to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_prior_day_trade_message = Pref.bool("Show Prior Day Trade Message", show.prior_day_trade_message, "Parse and add Prior Day Trade Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_reset_block_sequence_number_message = Pref.bool("Show Reset Block Sequence Number Message", show.reset_block_sequence_number_message, "Parse and add Reset Block Sequence Number Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_sale_conditions = Pref.bool("Show Sale Conditions", show.sale_conditions, "Parse and add Sale Conditions to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_short_trade_message = Pref.bool("Show Short Trade Message", show.short_trade_message, "Parse and add Short Trade Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_sip_block_timestamp = Pref.bool("Show Sip Block Timestamp", show.sip_block_timestamp, "Parse and add Sip Block Timestamp to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_start_of_day_message = Pref.bool("Show Start Of Day Message", show.start_of_day_message, "Parse and add Start Of Day Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_start_of_end_of_day_message = Pref.bool("Show Start Of End Of Day Message", show.start_of_end_of_day_message, "Parse and add Start Of End Of Day Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_start_of_start_of_day_message = Pref.bool("Show Start Of Start Of Day Message", show.start_of_start_of_day_message, "Parse and add Start Of Start Of Day Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_summary = Pref.bool("Show Summary", show.summary, "Parse and add Summary to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_timestamp_1 = Pref.bool("Show Timestamp 1", show.timestamp_1, "Parse and add Timestamp 1 to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_timestamp_2 = Pref.bool("Show Timestamp 2", show.timestamp_2, "Parse and add Timestamp 2 to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_trade = Pref.bool("Show Trade", show.trade, "Parse and add Trade to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_trade_cancel_error_message = Pref.bool("Show Trade Cancel Error Message", show.trade_cancel_error_message, "Parse and add Trade Cancel Error Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_trade_correction_message = Pref.bool("Show Trade Correction Message", show.trade_correction_message, "Parse and add Trade Correction Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_trading_status_message = Pref.bool("Show Trading Status Message", show.trading_status_message, "Parse and add Trading Status Message to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_administrative_payload = Pref.bool("Show Administrative Payload", show.administrative_payload, "Parse and add Administrative Payload to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_control_payload = Pref.bool("Show Control Payload", show.control_payload, "Parse and add Control Payload to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_index_payload = Pref.bool("Show Index Payload", show.index_payload, "Parse and add Index Payload to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_market_status_payload = Pref.bool("Show Market Status Payload", show.market_status_payload, "Parse and add Market Status Payload to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_prior_day_payload = Pref.bool("Show Prior Day Payload", show.prior_day_payload, "Parse and add Prior Day Payload to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_summary_payload = Pref.bool("Show Summary Payload", show.summary_payload, "Parse and add Summary Payload to protocol tree")
siac_cts_output_cta_v2_9.prefs.show_trade_payload = Pref.bool("Show Trade Payload", show.trade_payload, "Parse and add Trade Payload to protocol tree")

-- Handle changed preferences
function siac_cts_output_cta_v2_9.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.administrative ~= siac_cts_output_cta_v2_9.prefs.show_administrative then
    show.administrative = siac_cts_output_cta_v2_9.prefs.show_administrative
    changed = true
  end
  if show.approximate_adjusted_volume_market_center_message ~= siac_cts_output_cta_v2_9.prefs.show_approximate_adjusted_volume_market_center_message then
    show.approximate_adjusted_volume_market_center_message = siac_cts_output_cta_v2_9.prefs.show_approximate_adjusted_volume_market_center_message
    changed = true
  end
  if show.approximate_trades_and_total_dollar_value_message ~= siac_cts_output_cta_v2_9.prefs.show_approximate_trades_and_total_dollar_value_message then
    show.approximate_trades_and_total_dollar_value_message = siac_cts_output_cta_v2_9.prefs.show_approximate_trades_and_total_dollar_value_message
    changed = true
  end
  if show.auction_status_message ~= siac_cts_output_cta_v2_9.prefs.show_auction_status_message then
    show.auction_status_message = siac_cts_output_cta_v2_9.prefs.show_auction_status_message
    changed = true
  end
  if show.bid_and_offer_index_message ~= siac_cts_output_cta_v2_9.prefs.show_bid_and_offer_index_message then
    show.bid_and_offer_index_message = siac_cts_output_cta_v2_9.prefs.show_bid_and_offer_index_message
    changed = true
  end
  if show.block_header ~= siac_cts_output_cta_v2_9.prefs.show_block_header then
    show.block_header = siac_cts_output_cta_v2_9.prefs.show_block_header
    changed = true
  end
  if show.consolidated_data ~= siac_cts_output_cta_v2_9.prefs.show_consolidated_data then
    show.consolidated_data = siac_cts_output_cta_v2_9.prefs.show_consolidated_data
    changed = true
  end
  if show.consolidated_end_of_day_summary_message ~= siac_cts_output_cta_v2_9.prefs.show_consolidated_end_of_day_summary_message then
    show.consolidated_end_of_day_summary_message = siac_cts_output_cta_v2_9.prefs.show_consolidated_end_of_day_summary_message
    changed = true
  end
  if show.consolidated_start_of_day_summary_message ~= siac_cts_output_cta_v2_9.prefs.show_consolidated_start_of_day_summary_message then
    show.consolidated_start_of_day_summary_message = siac_cts_output_cta_v2_9.prefs.show_consolidated_start_of_day_summary_message
    changed = true
  end
  if show.control ~= siac_cts_output_cta_v2_9.prefs.show_control then
    show.control = siac_cts_output_cta_v2_9.prefs.show_control
    changed = true
  end
  if show.corrected_trade ~= siac_cts_output_cta_v2_9.prefs.show_corrected_trade then
    show.corrected_trade = siac_cts_output_cta_v2_9.prefs.show_corrected_trade
    changed = true
  end
  if show.crossing_session_summary_message ~= siac_cts_output_cta_v2_9.prefs.show_crossing_session_summary_message then
    show.crossing_session_summary_message = siac_cts_output_cta_v2_9.prefs.show_crossing_session_summary_message
    changed = true
  end
  if show.disaster_recovery_data_center_activation_message ~= siac_cts_output_cta_v2_9.prefs.show_disaster_recovery_data_center_activation_message then
    show.disaster_recovery_data_center_activation_message = siac_cts_output_cta_v2_9.prefs.show_disaster_recovery_data_center_activation_message
    changed = true
  end
  if show.end_of_day_message ~= siac_cts_output_cta_v2_9.prefs.show_end_of_day_message then
    show.end_of_day_message = siac_cts_output_cta_v2_9.prefs.show_end_of_day_message
    changed = true
  end
  if show.end_of_end_of_day_message ~= siac_cts_output_cta_v2_9.prefs.show_end_of_end_of_day_message then
    show.end_of_end_of_day_message = siac_cts_output_cta_v2_9.prefs.show_end_of_end_of_day_message
    changed = true
  end
  if show.end_of_start_of_day_message ~= siac_cts_output_cta_v2_9.prefs.show_end_of_start_of_day_message then
    show.end_of_start_of_day_message = siac_cts_output_cta_v2_9.prefs.show_end_of_start_of_day_message
    changed = true
  end
  if show.index ~= siac_cts_output_cta_v2_9.prefs.show_index then
    show.index = siac_cts_output_cta_v2_9.prefs.show_index
    changed = true
  end
  if show.index_message ~= siac_cts_output_cta_v2_9.prefs.show_index_message then
    show.index_message = siac_cts_output_cta_v2_9.prefs.show_index_message
    changed = true
  end
  if show.line_integrity_message ~= siac_cts_output_cta_v2_9.prefs.show_line_integrity_message then
    show.line_integrity_message = siac_cts_output_cta_v2_9.prefs.show_line_integrity_message
    changed = true
  end
  if show.long_trade_message ~= siac_cts_output_cta_v2_9.prefs.show_long_trade_message then
    show.long_trade_message = siac_cts_output_cta_v2_9.prefs.show_long_trade_message
    changed = true
  end
  if show.market_status ~= siac_cts_output_cta_v2_9.prefs.show_market_status then
    show.market_status = siac_cts_output_cta_v2_9.prefs.show_market_status
    changed = true
  end
  if show.market_wide_circuit_breaker_decline_level_status_message ~= siac_cts_output_cta_v2_9.prefs.show_market_wide_circuit_breaker_decline_level_status_message then
    show.market_wide_circuit_breaker_decline_level_status_message = siac_cts_output_cta_v2_9.prefs.show_market_wide_circuit_breaker_decline_level_status_message
    changed = true
  end
  if show.market_wide_circuit_breaker_status_message ~= siac_cts_output_cta_v2_9.prefs.show_market_wide_circuit_breaker_status_message then
    show.market_wide_circuit_breaker_status_message = siac_cts_output_cta_v2_9.prefs.show_market_wide_circuit_breaker_status_message
    changed = true
  end
  if show.message ~= siac_cts_output_cta_v2_9.prefs.show_message then
    show.message = siac_cts_output_cta_v2_9.prefs.show_message
    changed = true
  end
  if show.message_header ~= siac_cts_output_cta_v2_9.prefs.show_message_header then
    show.message_header = siac_cts_output_cta_v2_9.prefs.show_message_header
    changed = true
  end
  if show.original_trade ~= siac_cts_output_cta_v2_9.prefs.show_original_trade then
    show.original_trade = siac_cts_output_cta_v2_9.prefs.show_original_trade
    changed = true
  end
  if show.packet ~= siac_cts_output_cta_v2_9.prefs.show_packet then
    show.packet = siac_cts_output_cta_v2_9.prefs.show_packet
    changed = true
  end
  if show.participant_data ~= siac_cts_output_cta_v2_9.prefs.show_participant_data then
    show.participant_data = siac_cts_output_cta_v2_9.prefs.show_participant_data
    changed = true
  end
  if show.participant_end_of_day_summary_message ~= siac_cts_output_cta_v2_9.prefs.show_participant_end_of_day_summary_message then
    show.participant_end_of_day_summary_message = siac_cts_output_cta_v2_9.prefs.show_participant_end_of_day_summary_message
    changed = true
  end
  if show.participant_start_of_day_summary_message ~= siac_cts_output_cta_v2_9.prefs.show_participant_start_of_day_summary_message then
    show.participant_start_of_day_summary_message = siac_cts_output_cta_v2_9.prefs.show_participant_start_of_day_summary_message
    changed = true
  end
  if show.participants ~= siac_cts_output_cta_v2_9.prefs.show_participants then
    show.participants = siac_cts_output_cta_v2_9.prefs.show_participants
    changed = true
  end
  if show.prior_day ~= siac_cts_output_cta_v2_9.prefs.show_prior_day then
    show.prior_day = siac_cts_output_cta_v2_9.prefs.show_prior_day
    changed = true
  end
  if show.prior_day_trade_correction_message ~= siac_cts_output_cta_v2_9.prefs.show_prior_day_trade_correction_message then
    show.prior_day_trade_correction_message = siac_cts_output_cta_v2_9.prefs.show_prior_day_trade_correction_message
    changed = true
  end
  if show.prior_day_trade_date_and_time ~= siac_cts_output_cta_v2_9.prefs.show_prior_day_trade_date_and_time then
    show.prior_day_trade_date_and_time = siac_cts_output_cta_v2_9.prefs.show_prior_day_trade_date_and_time
    changed = true
  end
  if show.prior_day_trade_message ~= siac_cts_output_cta_v2_9.prefs.show_prior_day_trade_message then
    show.prior_day_trade_message = siac_cts_output_cta_v2_9.prefs.show_prior_day_trade_message
    changed = true
  end
  if show.reset_block_sequence_number_message ~= siac_cts_output_cta_v2_9.prefs.show_reset_block_sequence_number_message then
    show.reset_block_sequence_number_message = siac_cts_output_cta_v2_9.prefs.show_reset_block_sequence_number_message
    changed = true
  end
  if show.sale_conditions ~= siac_cts_output_cta_v2_9.prefs.show_sale_conditions then
    show.sale_conditions = siac_cts_output_cta_v2_9.prefs.show_sale_conditions
    changed = true
  end
  if show.short_trade_message ~= siac_cts_output_cta_v2_9.prefs.show_short_trade_message then
    show.short_trade_message = siac_cts_output_cta_v2_9.prefs.show_short_trade_message
    changed = true
  end
  if show.sip_block_timestamp ~= siac_cts_output_cta_v2_9.prefs.show_sip_block_timestamp then
    show.sip_block_timestamp = siac_cts_output_cta_v2_9.prefs.show_sip_block_timestamp
    changed = true
  end
  if show.start_of_day_message ~= siac_cts_output_cta_v2_9.prefs.show_start_of_day_message then
    show.start_of_day_message = siac_cts_output_cta_v2_9.prefs.show_start_of_day_message
    changed = true
  end
  if show.start_of_end_of_day_message ~= siac_cts_output_cta_v2_9.prefs.show_start_of_end_of_day_message then
    show.start_of_end_of_day_message = siac_cts_output_cta_v2_9.prefs.show_start_of_end_of_day_message
    changed = true
  end
  if show.start_of_start_of_day_message ~= siac_cts_output_cta_v2_9.prefs.show_start_of_start_of_day_message then
    show.start_of_start_of_day_message = siac_cts_output_cta_v2_9.prefs.show_start_of_start_of_day_message
    changed = true
  end
  if show.summary ~= siac_cts_output_cta_v2_9.prefs.show_summary then
    show.summary = siac_cts_output_cta_v2_9.prefs.show_summary
    changed = true
  end
  if show.timestamp_1 ~= siac_cts_output_cta_v2_9.prefs.show_timestamp_1 then
    show.timestamp_1 = siac_cts_output_cta_v2_9.prefs.show_timestamp_1
    changed = true
  end
  if show.timestamp_2 ~= siac_cts_output_cta_v2_9.prefs.show_timestamp_2 then
    show.timestamp_2 = siac_cts_output_cta_v2_9.prefs.show_timestamp_2
    changed = true
  end
  if show.trade ~= siac_cts_output_cta_v2_9.prefs.show_trade then
    show.trade = siac_cts_output_cta_v2_9.prefs.show_trade
    changed = true
  end
  if show.trade_cancel_error_message ~= siac_cts_output_cta_v2_9.prefs.show_trade_cancel_error_message then
    show.trade_cancel_error_message = siac_cts_output_cta_v2_9.prefs.show_trade_cancel_error_message
    changed = true
  end
  if show.trade_correction_message ~= siac_cts_output_cta_v2_9.prefs.show_trade_correction_message then
    show.trade_correction_message = siac_cts_output_cta_v2_9.prefs.show_trade_correction_message
    changed = true
  end
  if show.trading_status_message ~= siac_cts_output_cta_v2_9.prefs.show_trading_status_message then
    show.trading_status_message = siac_cts_output_cta_v2_9.prefs.show_trading_status_message
    changed = true
  end
  if show.administrative_payload ~= siac_cts_output_cta_v2_9.prefs.show_administrative_payload then
    show.administrative_payload = siac_cts_output_cta_v2_9.prefs.show_administrative_payload
    changed = true
  end
  if show.control_payload ~= siac_cts_output_cta_v2_9.prefs.show_control_payload then
    show.control_payload = siac_cts_output_cta_v2_9.prefs.show_control_payload
    changed = true
  end
  if show.index_payload ~= siac_cts_output_cta_v2_9.prefs.show_index_payload then
    show.index_payload = siac_cts_output_cta_v2_9.prefs.show_index_payload
    changed = true
  end
  if show.market_status_payload ~= siac_cts_output_cta_v2_9.prefs.show_market_status_payload then
    show.market_status_payload = siac_cts_output_cta_v2_9.prefs.show_market_status_payload
    changed = true
  end
  if show.payload ~= siac_cts_output_cta_v2_9.prefs.show_payload then
    show.payload = siac_cts_output_cta_v2_9.prefs.show_payload
    changed = true
  end
  if show.prior_day_payload ~= siac_cts_output_cta_v2_9.prefs.show_prior_day_payload then
    show.prior_day_payload = siac_cts_output_cta_v2_9.prefs.show_prior_day_payload
    changed = true
  end
  if show.summary_payload ~= siac_cts_output_cta_v2_9.prefs.show_summary_payload then
    show.summary_payload = siac_cts_output_cta_v2_9.prefs.show_summary_payload
    changed = true
  end
  if show.trade_payload ~= siac_cts_output_cta_v2_9.prefs.show_trade_payload then
    show.trade_payload = siac_cts_output_cta_v2_9.prefs.show_trade_payload
    changed = true
  end
...
siac_cts_output_cta_v2_9_dissect.block_pad_byte = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.block_pad_byte, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.tick = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.tick, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.low_price = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.low_price, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.high_price = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.high_price, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.last_price = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.last_price, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.last_participant_id = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.last_participant_id, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.financial_status_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.financial_status_indicator, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.primary_listing_market_participant_id = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.primary_listing_market_participant_id, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.short_sale_restriction_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.short_sale_restriction_indicator, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.cancel_error_action = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.cancel_error_action, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.nanoseconds = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.nanoseconds, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.seconds = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.seconds, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.trade_reporting_facility_id = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.trade_reporting_facility_id, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.trade_through_exempt_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.trade_through_exempt_indicator, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.stop_stock_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.stop_stock_indicator, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.sellers_sale_days = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.sellers_sale_days, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.trade_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.trade_volume, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.trade_price = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.trade_price, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.trade_through_exempt_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.trade_through_exempt_reason, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.settlement_type = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.settlement_type, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.instrument_type = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.instrument_type, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.security_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.security_symbol, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.participant_reference_number = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.participant_reference_number, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.transaction_id = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.transaction_id, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.message_id = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.message_id, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.participant_id = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.participant_id, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.trade_cancel_error_message = function(buffer, offset, packet, parent)
  ...
  if show.trade_cancel_error_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.trade_cancel_error_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.participant_open_high_low_last_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.participant_open_high_low_last_indicator, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.consolidated_high_low_last_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.consolidated_high_low_last_indicator, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.trade_volume_short = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.trade_volume_short, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.trade_price_short = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.trade_price_short, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.sale_condition_category = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.sale_condition_category, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.sale_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.sale_condition, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.security_symbol_short = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.security_symbol_short, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.short_trade_message = function(buffer, offset, packet, parent)
  ...
  if show.short_trade_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.short_trade_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.limit_up_limit_down_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.limit_up_limit_down_indicator, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.halt_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.halt_reason, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.security_status = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.security_status, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.sell_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.sell_volume, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.buy_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.buy_volume, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.low_indication_price_lower_limit_price_band = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.low_indication_price_lower_limit_price_band, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.high_indication_price_upper_limit_price_band = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.high_indication_price_upper_limit_price_band, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.trading_status_message = function(buffer, offset, packet, parent)
  ...
  if show.trading_status_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.trading_status_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.held_trade_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.held_trade_indicator, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.long_trade_message = function(buffer, offset, packet, parent)
  ...
  if show.long_trade_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.long_trade_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.trade_correction_message = function(buffer, offset, packet, parent)
  ...
  if show.trade_correction_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.trade_correction_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.future_use = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.future_use, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.number_of_extensions = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.number_of_extensions, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.auction_collar_lower_threshold_price = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.auction_collar_lower_threshold_price, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.auction_collar_upper_threshold_price = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.auction_collar_upper_threshold_price, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.auction_collar_reference_price = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.auction_collar_reference_price, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.auction_status_message = function(buffer, offset, packet, parent)
  ...
  if show.auction_status_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.auction_status_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.trade_payload = function(buffer, offset, packet, parent, trade_message_type)
  ...
  local element = parent:add(siac_cts_output_cta_v2_9.fields.trade_payload, range, display)
...
siac_cts_output_cta_v2_9_dissect.trade_message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.trade_message_type, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.trade = function(buffer, offset, packet, parent)
  ...
  if show.trade then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.trade, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.initiating_participant_id = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.initiating_participant_id, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.participant_end_of_day_summary_message = function(buffer, offset, packet, parent)
  ...
  if show.participant_end_of_day_summary_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.participant_end_of_day_summary_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.number_of_participants = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.number_of_participants, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.consolidated_end_of_day_summary_message = function(buffer, offset, packet, parent)
  ...
  if show.consolidated_end_of_day_summary_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.consolidated_end_of_day_summary_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.previous_close_price = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.previous_close_price, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.participant_start_of_day_summary_message = function(buffer, offset, packet, parent)
  ...
  if show.participant_start_of_day_summary_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.participant_start_of_day_summary_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.consolidated_start_of_day_summary_message = function(buffer, offset, packet, parent)
  ...
  if show.consolidated_start_of_day_summary_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.consolidated_start_of_day_summary_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.summary_payload = function(buffer, offset, packet, parent, summary_message_type)
  ...
  local element = parent:add(siac_cts_output_cta_v2_9.fields.summary_payload, range, display)
...
siac_cts_output_cta_v2_9_dissect.summary_message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.summary_message_type, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.summary = function(buffer, offset, packet, parent)
  ...
  if show.summary then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.summary, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.prior_day_trade_message = function(buffer, offset, packet, parent)
  ...
  if show.prior_day_trade_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.prior_day_trade_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.prior_day_trade_correction_message = function(buffer, offset, packet, parent)
  ...
  if show.prior_day_trade_correction_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.prior_day_trade_correction_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.prior_day_payload = function(buffer, offset, packet, parent, prior_day_message_type)
  ...
  local element = parent:add(siac_cts_output_cta_v2_9.fields.prior_day_payload, range, display)
...
siac_cts_output_cta_v2_9_dissect.prior_day_message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.prior_day_message_type, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.prior_day = function(buffer, offset, packet, parent)
  ...
  if show.prior_day then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.prior_day, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.crossing_session_2_total_trades_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.crossing_session_2_total_trades_volume, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.crossing_session_2_dollar_value = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.crossing_session_2_dollar_value, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.crossing_session_1_total_trades_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.crossing_session_1_total_trades_volume, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.crossing_session_summary_message = function(buffer, offset, packet, parent)
  ...
  if show.crossing_session_summary_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.crossing_session_summary_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.dollar_value = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.dollar_value, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.total_trades = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.total_trades, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.approximate_trades_and_total_dollar_value_message = function(buffer, offset, packet, parent)
  ...
  if show.approximate_trades_and_total_dollar_value_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.approximate_trades_and_total_dollar_value_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.trade_total_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.trade_total_volume, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.participants_fields = function(buffer, offset, packet, parent)
  local index = offset
...
siac_cts_output_cta_v2_9_dissect.approximate_adjusted_volume_market_center_message_fields = function(buffer, offset, packet, parent, size_of_approximate_adjusted_volume_market_center_message)
  ...
  for i = 1, number_of_participants do
    index = siac_cts_output_cta_v2_9_dissect.participants(buffer, index, packet, parent)
  end
...
siac_cts_output_cta_v2_9_dissect.approximate_adjusted_volume_market_center_message = function(buffer, offset, packet, parent)
  ...
  if show.approximate_adjusted_volume_market_center_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.approximate_adjusted_volume_market_center_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.reserved = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.reserved, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.market_wide_circuit_breaker_status_message = function(buffer, offset, packet, parent)
  ...
  if show.market_wide_circuit_breaker_status_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.market_wide_circuit_breaker_status_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.mwcb_level_3 = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.mwcb_level_3, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.mwcb_level_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.mwcb_level_2, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.market_wide_circuit_breaker_decline_level_status_message = function(buffer, offset, packet, parent)
  ...
  if show.market_wide_circuit_breaker_decline_level_status_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.market_wide_circuit_breaker_decline_level_status_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.market_status_payload = function(buffer, offset, packet, parent, market_status_message_type)
  ...
  local element = parent:add(siac_cts_output_cta_v2_9.fields.market_status_payload, range, display)
...
siac_cts_output_cta_v2_9_dissect.market_status_message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.market_status_message_type, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.market_status = function(buffer, offset, packet, parent)
  ...
  if show.market_status then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.market_status, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.offer_index_value = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.offer_index_value, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.bid_index_value = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.bid_index_value, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.index_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.index_symbol, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.bid_and_offer_index_message = function(buffer, offset, packet, parent)
  ...
  if show.bid_and_offer_index_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.bid_and_offer_index_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.index_value = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.index_value, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.index_message = function(buffer, offset, packet, parent)
  ...
  if show.index_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.index_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.index_payload = function(buffer, offset, packet, parent, index_message_type)
  ...
  local element = parent:add(siac_cts_output_cta_v2_9.fields.index_payload, range, display)
...
siac_cts_output_cta_v2_9_dissect.index_message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.index_message_type, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.index = function(buffer, offset, packet, parent)
  ...
  if show.index then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.index, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.end_of_day_message = function(buffer, offset, packet, parent)
  ...
  if show.end_of_day_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.end_of_day_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.line_integrity_message = function(buffer, offset, packet, parent)
  ...
  if show.line_integrity_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.line_integrity_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.disaster_recovery_data_center_activation_message = function(buffer, offset, packet, parent)
  ...
  if show.disaster_recovery_data_center_activation_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.disaster_recovery_data_center_activation_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.reset_block_sequence_number_message = function(buffer, offset, packet, parent)
  ...
  if show.reset_block_sequence_number_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.reset_block_sequence_number_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.start_of_day_message = function(buffer, offset, packet, parent)
  ...
  if show.start_of_day_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.start_of_day_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.control_payload = function(buffer, offset, packet, parent, control_message_type)
  ...
  local element = parent:add(siac_cts_output_cta_v2_9.fields.control_payload, range, display)
...
siac_cts_output_cta_v2_9_dissect.control_message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.control_message_type, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.control = function(buffer, offset, packet, parent)
  ...
  if show.control then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.control, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.end_of_start_of_day_message = function(buffer, offset, packet, parent)
  ...
  if show.end_of_start_of_day_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.end_of_start_of_day_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.start_of_start_of_day_message = function(buffer, offset, packet, parent)
  ...
  if show.start_of_start_of_day_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.start_of_start_of_day_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.end_of_end_of_day_message = function(buffer, offset, packet, parent)
  ...
  if show.end_of_end_of_day_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.end_of_end_of_day_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.start_of_end_of_day_message = function(buffer, offset, packet, parent)
  ...
  if show.start_of_end_of_day_message then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.start_of_end_of_day_message, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.administrative_payload = function(buffer, offset, packet, parent, administrative_message_type)
  ...
  local element = parent:add(siac_cts_output_cta_v2_9.fields.administrative_payload, range, display)
...
siac_cts_output_cta_v2_9_dissect.administrative_message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.administrative_message_type, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.administrative = function(buffer, offset, packet, parent)
  ...
  if show.administrative then
    ...
    parent = parent:add(siac_cts_output_cta_v2_9.fields.administrative, range, display)
  end
...
siac_cts_output_cta_v2_9_dissect.payload = function(buffer, offset, packet, parent, message_category)
  ...
  local element = parent:add(siac_cts_output_cta_v2_9.fields.payload, range, display)
...
siac_cts_output_cta_v2_9_dissect.message_category = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.message_category, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.message_length = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.message_length, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.message_fields = function(buffer, offset, packet, parent, size_of_message)
  local index = offset
...
-- Dissect: Message
siac_cts_output_cta_v2_9_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  -- Optionally add struct element to protocol tree
  if show.message then
    local range = buffer(offset, size_of_message)
    local display = siac_cts_output_cta_v2_9_display.message(buffer, packet, parent)
    parent = parent:add(siac_cts_output_cta_v2_9.fields.message, range, display)
  end

  siac_cts_output_cta_v2_9_dissect.message_fields(buffer, offset, packet, parent, size_of_message)
...
siac_cts_output_cta_v2_9_dissect.block_checksum = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.block_checksum, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.messages_in_block = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.messages_in_block, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.block_sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.block_sequence_number, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.retransmission_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.retransmission_indicator, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.data_feed_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.data_feed_indicator, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.block_size = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.block_size, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.version = function(buffer, offset, packet, parent)
  ...
  parent:add(siac_cts_output_cta_v2_9.fields.version, range, value, display)
...
siac_cts_output_cta_v2_9_dissect.packet = function(buffer, packet, parent)
  ...
  for i = 1, messages_in_block do
    ...
    -- Message: Struct of 2 fields
    index = siac_cts_output_cta_v2_9_dissect.message(buffer, index, packet, parent, message_length)
  end
  ...
  if block_pad_byte_exists then
    index = siac_cts_output_cta_v2_9_dissect.block_pad_byte(buffer, index, packet, parent)
  end
...
function siac_cts_output_cta_v2_9.init()
end

-- Dissector for Siac Cts Output Cta 2.9
function siac_cts_output_cta_v2_9.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = siac_cts_output_cta_v2_9.name

  -- Dissect protocol
  local protocol = parent:add(siac_cts_output_cta_v2_9, buffer(), siac_cts_output_cta_v2_9.description, "("..buffer:len().." Bytes)")
  return siac_cts_output_cta_v2_9_dissect.packet(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, siac_cts_output_cta_v2_9)
...
verify.siac_cts_output_cta_v2_9_packet_size = function(buffer)

  return true
end

-- Dissector Heuristic for Siac Cts Output Cta 2.9
local function siac_cts_output_cta_v2_9_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.siac_cts_output_cta_v2_9_packet_size(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = siac_cts_output_cta_v2_9
  siac_cts_output_cta_v2_9.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Siac Cts Output Cta 2.9
siac_cts_output_cta_v2_9:register_heuristic("udp", siac_cts_output_cta_v2_9_heuristic)
